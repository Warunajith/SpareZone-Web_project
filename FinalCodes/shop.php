        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-item">
                <a class="nav-link text-white
                     <?php if($_GET['page']=="Breaks")
                        {
                            $pagecode="B";
                            echo "bg-warning";
                        }
 
                    ?> " href="shop.php?page=<?php echo"Breaks";?>"><h5>Breaks & Suspension</h5></a>
      
                <!-- PHP code is to highlight each category-->

            </li>
            <li class="nav-item">
                <a class="nav-link text-white
                
                <?php if($_GET['page']=="BodyParts")
                        {
                            $pagecode="P";
                            echo "bg-warning";
                        }
 
                    ?>" href="shop.php?page=<?php echo"BodyParts";?>"><h5>Body Parts & Mirrors</h5></a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white
                <?php if($_GET['page']=="Lights")
                        {
                            $pagecode="L";
                            echo "bg-warning";
                        }
 
                    ?>" href="shop.php?page=<?php echo"Lights";?>"><h5>Lights</h5></a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white
                <?php if($_GET['page']=="EngineParts")
                        {
                            $pagecode="G";
                            echo "bg-warning";
                        }
 
                    ?> " href="shop.php?page=<?php echo"EngineParts";?>"><h5>Engine Parts</h5></a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white 
                <?php if($_GET['page']=="ElectricalParts")
                        {
                            $pagecode="T";
                            echo "bg-warning";
                        }
 
                    ?>" href="shop.php?page=<?php echo"ElectricalParts";?>"><h5>Electrical Parts</h5></a>
            </li>
        </ul>
    </nav>
</div>
    ...
    <div class="row" >
        ...
        ?>
            <tr>
              ...
              $result = mysqli_query($con, "SELECT * FROM `items` WHERE code LIKE '".$pagecode."%' LIMIT ".(($rowcount*4))." , ".(($rowcount*4)+4)."");
