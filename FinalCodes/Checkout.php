...
session_start();
include('db.php');
$con->query("DELETE FROM `temporary` ");
$status="";
...
<!--Payment gateway form stars here-->
 <form method="post" action="https://sandbox.payhere.lk/pay/checkout">   
    ...
    <div class="col-sm-5">
 <!--Add details here-->
 <h3 class="bg-success text-white"> &emsp;Shopping Details</h3>

 <div class="card bg-light text-dark" style="width:440px; height:800px;">
                <div class="card-body" style="font-size:20px;">
    <input type="hidden" name="merchant_id" value="1218693">    <!-- Replace your Merchant ID -->
    <input type="hidden" name="return_url" value="http://warunajith/SpareZone/redirect.php">
    <input type="hidden" name="cancel_url" value="http://warunajith/SpareZone/checkout.php">
    <input type="hidden" name="notify_url" value="http://warunajith/SpareZone/home.php">  
    
    <input type="hidden" name="order_id" value="">
    <input type="hidden" name="items" value=""><br>
    <input type="hidden" name="currency" value="LKR">
   <?php $result= $con->query("SELECT * FROM `customer` WHERE customer_id='".$_SESSION['userid']."'");

            $row=$result->fetch_array();
?>
    
    <label for="#">First Name</label><br>
    <input type="text" style="width:200px;" name="first_name" value="<?php echo $row['Fname'];?>"><br><br>
    <label for="#">Last Name</label><br>
    <input type="text" style="width:200px;" name="last_name" value="<?php echo $row['Lname'];?>"><br><br>
    <label for="#">E-Mail</label><br>
    <input type="text" style="width:350px;" name="email" value="<?php echo $row['email'];?>"><br><br>
    <label for="#">Phone</label><br>
    <input type="text"style="width:200px;" name="phone" value="<?php echo $row['Pnumber'];?>"><br><br>
    <label for="#">Adddress</label><br>
    <input type="text"style="width:400px;"name="address" value="<?php echo $row['address'];?>"><br><br>
    <label for="#">Hometown</label><br>
    <input type="text"style="width:200px;" name="city" value="<?php echo $row['hometown'];?>"><br><br>
    <label for="#">Postal Code</label><br>
    <input type="text" style="width:200px;"name="delivery_city" value="<?php echo $row['postalcode'];?>"><br><br>
    <input type="hidden" name="country" value="Sri Lanka"><br><br> 
        ...
        <div class="col-sm-7" >
            ...
            <h3 class="bg-success text-white"> &emsp;Order Overview</h3>
            ...
            <table class="table table-bordered">
                ...
                <?php		
                    foreach ($_SESSION["shopping_cart"] as $product){
                        $sql="INSERT INTO temporary values ('".$product["code"]."','".$product["price"]."','".$product["quantity"]."','".$product["price"]*$product["quantity"]."','".$_SESSION['userid']."')";
        ...
        <br>
            ...
            <div class="card bg-light text-dark" style="width:500px; height:450px;margin-left:60px;">
                <div class="card-body">
                    ...
                    <div style="text-align: center;">
                        ...
                        <button type="submit" class="btn btn-warning"  style="width:400px; height:50px;font-size:25px;">
                            ...
                            <a href="http://warunajith/SpareZone/redirect.php"></a>
