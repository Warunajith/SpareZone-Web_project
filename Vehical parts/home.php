    ...
    <div class="row" >
        ...
        <div style="margin-left:100px;">
            <tr>
                ...
                <?php
                $result = mysqli_query($con, "SELECT * FROM `items` LIMIT 4");
                                    ...
                                    <div class="product-item">
                                        <div class="pi-img-wrapper">
                                            ...
                                            <div class="text-center">
                                                <img src="img/<?php echo "" . $row['code'] . ""; ?>.jfif" class="img-responsive" alt="Berry Lace Dress"
                                        ...
                                        <h3><a href="shop-item.html"><?php echo "  " . $row['name'] . ""; ?></a></h3>
