...
<div class="container">
    <nav class="navbar navbar-expand-sm bg-dark">
        <ul class="nav nav-pills">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="#"><h5>Breaks & Suspension</h5></a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="#"><h5>Body Parts & Mirrors</h5></a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="#"><h5>Lights</h5></a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="#"><h5>Engine Parts</h5></a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="#"><h5>Electrical Parts</h5></a>
            </li>
        </ul>
    </nav>
</div>
